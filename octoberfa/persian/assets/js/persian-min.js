    ...
    Sortable.prototype.onDragStart = function($item, container, _super, event) {
        ...
        if (pointer) {
            this.cursorAdjustment = {
                left: (($(window).width() - (offset.left + $item.outerWidth()))),
...
moment.locale('en') +
    function($) {
        ...
        DateTimeConverter.prototype.getDateTimeValue = function() {
            ...
            var momentObj = moment(moment.tz(this.datetime, this.appTimezone)),
                result
            if (this.options.locale) {
                momentObj = momentObj.locale(this.options.locale)
            }
            if (this.options.timezone) {
                momentObj = moment(momentObj.tz(this.options.timezone))
            }
...
['getHours', 'getMilliseconds', 'getMinutes', 'getSeconds', 'getTime', 'getUTCDay', 'getUTCHours', 'getTimezoneOffset', 'getUTCMilliseconds', 'getUTCMinutes', 'getUTCSeconds', 'setHours', 'setMilliseconds', 'setMinutes', 'setSeconds', 'setTime', 'setUTCHours', 'setUTCMilliseconds', 'setUTCMinutes', 'setUTCSeconds', 'toISOString', 'toJSON', 'toString', 'toLocaleDateString', 'toLocaleTimeString', 'toTimeString', 'toUTCString', 'valueOf', 'getDay'].forEach((method) => {
...
(function(root, factory) {
    ...
    return function(Date, oDate) {
        ...
        var hasMoment = typeof moment === 'function',
            ...
            isDate = function(obj) {
                return ((/Object/).test(Object.prototype.toString.call(obj)) && typeof obj.getTime === "function" && !isNaN(obj.getTime())) || ((/Date/).test(Object.prototype.toString.call(obj)) && !isNaN(obj.getTime()));
            },
            ...
            renderDay = function(opts) {
                ...
                return '<td data-day="' + opts.day + '" class="' + arr.join(' ') + '" aria-selected="' + ariaSelected + '">' + '<button class="pika-button pika-day" type="button" ' + 'data-pika-year="' + opts.year + '" data-pika-month="' + opts.month + '" data-pika-day="' + opts.day + '">' +
                    (opts.persianNumbers ? digits_en2fa(opts.day) : opts.day) + '</button>' + '</td>';
            },
...
(function(root, factory) {
    ...
    DatePicker.prototype.initDatePicker = function() {
        var self = this,
            ...
            now = moment(moment().tz(this.timezone)).format()
        var pikadayOptions = {
    ...
    DatePicker.prototype.getMomentLoadValue = function(value, format) {
        var momentObj = moment(moment.tz(value, this.appTimezone))
        momentObj = moment(momentObj.tz(this.timezone))
        return momentObj.format(format)
    }
}(window.jQuery); + function($) {
    var removeList = ["a", "an", "as", "at", "before", "but", "by", "for", "from", "is", "in", "into", "like", "of", "off", "on", "onto", "per", "since", "than", "the", "this", "that", "to", "up", "via", "with", 'از', 'به', 'در', 'با', 'یا', 'یک', 'قبل', 'است', 'بالا', 'پایین', 'این', 'آن']
    ...
    InputPreset.prototype.formatValue = function() {
        if (this.options.inputPresetType == 'namespace' || this.options.inputPresetType == 'camel' || this.options.inputPresetType == 'file') {
